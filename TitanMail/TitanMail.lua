...
-- 4.1 Update for Warlords of Draenor by Elmseeker

-- Version information
local TITAN_MAIL_VERSION = 4.1;
-- Constants
TITAN_MAIL_ID = "Mail";
...
local TPM_player =  GetUnitName("player", showServerName).. UnitName("player") -- GetCVar("RealmName").. UnitName("player");
