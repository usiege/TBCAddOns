...
P=(math.floor(GetPVPRankProgress(target)*10000))/100 W=UnitPVPRank("player") N=(W-6)*5000+5000*P/100 Q=(W-5)*5000-N*0.8 SendChatMessage("(RankClassic) - Current Rank: "..CurrentRank.." - Rank Progress: "..P.."% - ".."Current RP: "..N.." - RP to Next Rank: "..Q.." ","emote");
end;

SLASH_RANK1 = "/rank";
SlashCmdList["RANK"] = function(msg)
ClassicRank()
end
