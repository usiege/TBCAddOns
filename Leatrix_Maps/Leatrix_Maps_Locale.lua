...
L["Reveal Map"] = "顯示未探索區域"
L["Show dungeon location icons"] = "顯示副本入口圖示"
L["Reveal unexplored areas of the map"] = "顯示地圖中未探索的區域"
L["Hide map blackout frame"] = "隱藏地圖兩側的黑色區塊"
L["Fade Map"] = "淡出地圖"
L["Fade map when moving"] = "角色移動時淡出地圖"
L["Map opacity while moving"] = "移動時地圖的不透明度"
L["Opacity"] = "不透明度"
L["Configuration Panel"] = "設定面板"
L["Settings"] = "設定"
L["Memory Usage"] = "使用記憶體"
L["Rescale map frame"] = "調整地圖視窗大小"
L["Rescale Map"] = "調整地圖大小"
L["Map frame scale"] = "縮放地圖視窗"
L["Scale"] = "縮放大小"
end
